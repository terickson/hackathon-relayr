...
deviceIds = ['280dc96f-1e6b-49ad-b2ff-59897775f4cb', 'f46dd0b3-2dc7-402c-a5bc-d56ae8e39977', '46a4fa64-ac35-4142-9b0a-e62ef4ca2c8f', 'c7db7583-e019-4194-98c2-51a57e7fd728']
...
class socketSetup:
    ...
    def socketIO_callback(self, topic, payload):
        ...
        for reading in payloadDict['readings']:
            ...
            requests.put('http://prod--hackathon2016--hackathon-api--bc5588.gce.shipped-cisco.com/sensors/' + self.event, {'name': self.event, 'value': data['count']}, headers={'Content-Type': 'application/json'})

count = 1
for deviceId in deviceIds:
    tempRelayr = RelayrService(token, deviceId)
    socket = socketSetup('beeCount' + str(count))
